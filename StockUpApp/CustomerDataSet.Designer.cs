...
namespace StockUpApp {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string FirstName, string LastName, string Phone, string Email, System.DateTime DOB) {
...
namespace StockUpApp.CustomerDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([Id] = @Original_Id) AND ([DOB] = @Original" +
                "_DOB))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([FirstName], [LastName], [Phone], [Email], [DOB]) " +
                "VALUES (@FirstName, @LastName, @Phone, @Email, @DOB);\r\nSELECT Id, FirstName, Las" +
                "tName, Phone, Email, DOB FROM Customers WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [FirstName] = @FirstName, [LastName] = @LastName, [Phone] = @Phone, [Email] = @Email, [DOB] = @DOB WHERE (([Id] = @Original_Id) AND ([DOB] = @Original_DOB));
SELECT Id, FirstName, LastName, Phone, Email, DOB FROM Customers WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::StockUpApp.Properties.Settings.Default.retailConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Phone, Email, DOB FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_Id, System.DateTime Original_DOB) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Phone, string Email, System.DateTime DOB) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Phone, string Email, System.DateTime DOB, int Original_Id, System.DateTime Original_DOB, int Id) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Phone, string Email, System.DateTime DOB, int Original_Id, System.DateTime Original_DOB) {
            return this.Update(FirstName, LastName, Phone, Email, DOB, Original_Id, Original_DOB, Original_Id);
        }
    }
